...
SKILL_REPO="DUBSOpenHub/copilot-skill-builder"
...
echo "📥 Adding Copilot Skill Builder..."
mkdir -p "$SKILL_DIR"
if curl -fsSL "$SKILL_URL" -o "$SKILL_DIR/SKILL.md"; then
  echo "✅ Skill installed to $SKILL_DIR"
else
  echo "❌ Failed to download the skill. Check your internet connection."
  exit 1
fi
